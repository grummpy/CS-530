...
MOVES: dict[str, MoveDefinition] = {
    "5L": MoveDefinition("5L", 4, 3, 8, 40, 10, 8, 4, 4, 0, HitLevel.MID, 40, (_hb(4, 7, 20, -130, 70, 30),)),
    "5M": MoveDefinition("5M", 7, 4, 12, 70, 14, 11, 6, 6, 0, HitLevel.MID, 60, (_hb(7, 11, 24, -140, 90, 40),)),
    "5H": MoveDefinition("5H", 11, 4, 18, 110, 18, 14, 8, 8, -2, HitLevel.MID, 90, (_hb(11, 15, 28, -150, 110, 50),), launch=True),
    "2L": MoveDefinition("2L", 4, 3, 8, 35, 10, 8, 4, 3, 0, HitLevel.LOW, 35, (_hb(4, 7, 16, -50, 80, 28),)),
    "THROW": MoveDefinition("THROW", 4, 2, 14, 120, 20, 0, 6, 14, 0, HitLevel.MID, 80, (_hb(4, 6, 10, -140, 70, 120),), is_throw=True),
}
