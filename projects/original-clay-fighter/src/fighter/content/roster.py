...
PLAYABLE = ("rhinestone_angel", "mr_president", "tech_billionaire", "master_chef", "captain_campaign", "baron_boardroom", "doctor_broadcast", "general_gadget", "general_gravy", "influence_oracle")
